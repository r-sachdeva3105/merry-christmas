...
shareButton.onclick = () => {
    ...
    const data = {
        ...
        text: setName[0].toUpperCase() + setName.slice(1) + " wishing you merry christmas!!",
        url: `${window.location.origin}?name=${setName}`,
    };

    navigator.clipboard.writeText(`${window.location.origin}?name=${setName}`);
